...
![image-20190925215603036](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20190925215603036-9419777.png)
...
![image-20200311182438041](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200311182438041.png)

### 2.2 RabbitMQ 的安装

#### 2.2.1 下载

`官网下载地址`: https://www.rabbitmq.com/download.html![image-20190925220115235](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20190925220115235.png)

> `最新版本`: 3.7.18

#### 2.2.2 下载的安装包![image-20190925220343521](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20190925220343521.png)
...
![image-20190925222230260](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20190925222230260-3836271.png)

将上图中配置文件中红色部分去掉`%%`,以及最后的`,`逗号 修改为下图:

![image-20190925222329200](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20190925222329200-3836312.png)
...
![image-20190925222743776](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20190925222743776-3836511.png)
...
![image-20190926194954822](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20190926194954822-3836665.png)
...
![image-20191126162026720](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20191126162026720.png)
...
![image-20191126162617280](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20191126162617280.png)
...
![image-20191126163631889](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20191126163631889.png)
...
![image-20200312140114784](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200312140114784.png)
...
![image-20191126165840602](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20191126165840602.png)
...
![image-20200314223242058](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200314223242058.png)

![image-20200314223302207](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200314223302207.png)
...
- 关闭消息的自动确认,开启手动确认消息
  ...
  ![image-20200314230412178](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200314230412178.png)

  ![image-20200314230423280](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200314230423280.png)
...
![image-20200315180653207](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200315180653207.png)

![image-20200315180708489](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200315180708489.png)

![image-20200315180728035](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200315180728035.png)
...
![image-20191126220145375](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20191126220145375.png)
...
2. ##### 集群搭建
   ...
   ![image-20200320095613586](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200320095613586.png)

   ```markdown
   # 9.测试集群在node1上,创建队列
   ```

   ![image-20200320095743935](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200320095743935.png)

   ```markdown
   # 10.查看node2和node3节点:
   ```

   ![image-20200320095827688](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200320095827688.png)

   ![image-20200320095843370](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200320095843370.png)
   ...
   ![image-20200320100000347](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200320100000347.png)

   ![image-20200320100010968](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/image-20200320100010968.png)
...
![image-20230331104848896](https://typora-picgo-images-zhixi.oss-cn-beijing.aliyuncs.com/202303311048078.png)
